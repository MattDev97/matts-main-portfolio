    ...
    return (
        ...
        <form className="md:w-3/4 mx-auto">
            <div className="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    <label for="first_name" className="block mb-2 text-sm font-medium  dark:text-white">First name</label>
                ...
                <div>
                    <label for="last_name" className="block mb-2 text-sm font-medium  dark:text-white">Last name</label>
            ...
            <div className="mb-6">
                <label for="email" className="block mb-2 text-sm font-mediu dark:text-white">Email address</label>
                <input type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="john.doe@company.com" required></input>
            </div>
            <div class="mb-6">
                <label for="large-input" class="block mb-2 text-sm font-medium dark:text-white">What Do You Wanna say?</label>
